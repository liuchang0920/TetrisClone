...
public class ScreenFader : MonoBehaviour {
	...
	void Start () {
        ...
        m_inc = ((m_targetAlpha - m_startAlpha) / m_timeToFade) * Time.deltaTime; // look up api
    ...
    /**
     * invoke coroutines:
     * 1. method name as a string
     * 2. method name with parenthesis
     * 3. cannot be invoked in update, lateupdate, fixedupdate
     * 
     **/
    IEnumerator FadeRoutine()
    {
        ...
        // Debug.LogWarning("screen fader finished");
    }
